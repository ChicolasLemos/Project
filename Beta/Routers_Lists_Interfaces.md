...
ip nat inside source static tcp 172.17.2.2 80 2.2.0.2 80 
ip nat inside source static tcp 172.17.2.2 443 2.2.0.2 443
```
```
access-list 100 permit tcp any any eq www
access-list 100 permit tcp any any eq 443
access-list 100 permit ip any 2.2.0.0 0.0.0.3
```
Interfaces
```
